...
CREATE TABLE `wst_bargains` (
  ...
  `goodsSeoKeywords` varchar(200) NULL,
  `goodsSeoDesc` varchar(200) NULL,
...
INSERT INTO `wst_ad_positions`(positionType,positionName,positionWidth,positionHeight,dataFlag,positionCode,apSort) VALUES ('2', '微信版砍价广告', '375', '188', '1', 'wx-ads-bargain', '1021');

INSERT INTO `wst_ad_positions`(positionType,positionName,positionWidth,positionHeight,dataFlag,positionCode,apSort) VALUES('5', '微信小程序砍价广告', '375', '188', '1', 'weapp-ads-bargain', '0');
