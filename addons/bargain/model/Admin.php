...
class Admin extends Base{
	...
	public function pageQuery($grouponStatus){
		...
		if($goodsName !='')$where[] = ['b.goodsName','like','%'.$goodsName.'%'];
        ...
        $page =  Db::name('bargains')->alias('b')
                   ...
                   ->where($where)
                   ->field('b.*,g.goodsImg,s.shopId,s.shopName')
	...
	*/
	public function illegal(){
		...
		$rs = Db::name('bargains')->alias('b')
		           ...
		           ->where('bargainId',$id)
		           ->field('b.bargainId,b.shopId,s.userId,b.goodsName,b.bargainStatus,b.goodsId')->find();
