...
class Decoration extends Controller{
    ...
    public function setting() {
        ...
        $this->assign('decorationId', $decorationId);
       	return $this->fetch('/shop/shop_set');
    }
    ...
    public function edit() {
        ...
        return $this->fetch('/shop/shop_home');
    }
    ...
    public function blockAdd() {
        ...
        if($blockId) {
            ...
            $temp = $this->fetch('/shop/shop_decoration_block');
            $data['html'] = $temp;
    ...
    private function getBlockHtml($content, $module_type) {
        ...
        $temp = $this->fetch('/shop/shop_decoration_module_' . $module_type);
        return $temp;
    }
    ...
    public function goodsSearch() {
        ...
        $this->assign('gdata', $goods_list);
       	$goods= $this->fetch('/shop/shop_decoration_module_goods');
       	echo $goods;
    }
    ...
    public function preview() {
		...
		return $this->fetch('/shop/shop_decoration_preview');
    }
    ...
    public function build() {
		...
		$php = '';
		$php .='{wst:shopcats cat="0" num="10" shop="'.$shopId.'" id="ca"}';
		$php .='<a href="{:url("home/shops/goods",array("shopId"=>$ca["shopId"],"ct1"=>$ca["catId"]))}"><li class="liselect wst-lfloat">{$ca["catName"]}</li></a>';
		$php .='{/wst:shopcats}';
