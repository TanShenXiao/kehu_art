...
alter table `wst_orders` add dmoneyIsSettlement tinyint(4) default 0;
...
CREATE TABLE `wst_distribut_moneys` (
  ...
  `moneyStatus` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`moneyId`)
...
INSERT INTO `wst_navs`(navType,navTitle,navUrl,isShow,isOpen,navSort,createTime) VALUES ('0', '分销商品', 'addon/distribut-goods-glist', '1', '0', '0', '2015-07-12 20:10:00');
