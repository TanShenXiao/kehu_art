...
function goodsFilter(obj,vtype){
	...
	location.href=WST.U('addon/distribut-goods-glist',params.join('&'));
}
...
function searchFilter(obj,vtype){
	...
	location.href=WST.U('addon/distribut-goods-gsearch',params.join('&'));
}
...
function choiceArea(t,pid){
	...
	if(ids[2]==3){
		...
		var url = ($(t).attr('search')==1)?'addon/distribut-goods-gsearch':'addon/distribut-goods-glist';
