...
class Shops extends Controller{
	...
	public function pintuan(){
    	...
    	return $this->fetch($this->addonStyle."/shop/list");
	}
	/**
	 * 加载拼团数据
	 */
	...
	public function opentuan(){
        ...
        $this->assign("p",(int)input("p"));
    	return $this->fetch($this->addonStyle."/shop/open_list");
	}
	/**
	 * 加载开团列表
	 */
	...
	public function edit(){
        ...
        $this->assign("p",(int)input("p"));
		return $this->fetch($this->addonStyle."/shop/edit");
	}
    ...
    public function orders(){
    	$this->assign("tuanId",(int)input('tuanId'));
        $this->assign("p",(int)input("p"));
    	return $this->fetch($this->addonStyle."/shop/list_orders");
    }
    /**
     * 查询订单列表
     */ 
