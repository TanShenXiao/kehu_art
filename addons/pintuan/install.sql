...
INSERT INTO `wst_crons`(cronName,cronCode,isEnable,cronJson,cronUrl,cronDesc,cronCycle,cronDay,cronWeek,cronHour,cronMinute,runTime,nextTime,author,authorUrl) VALUES ('拼团失败退款', 'autoPintuanRefund', '1', 'b:0;', 'addon/pintuan-cron-tuanRefund.html', '到期拼团失败的退款', '2', '0', '0', '-1', '0,5,10,15,20,25,30,35,40,45,50,55', '2017-11-03 16:20:13', '2017-11-03 16:25:00','WSTMart', 'http://www.wstmart.net');
