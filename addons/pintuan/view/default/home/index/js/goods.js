...
function addCart(type,iptId){
	...
	$.post(WST.AU('pintuan://carts/addCart'),{id:goodsInfo.tuanId,buyNum:buyNum,tuanType:type,rnd:Math.random()},function(data,textStatus){
	     var json = WST.toJson(data);
	     if(json.status==1){
	    	 WST.msg(json.msg,{icon:1},function(){
	    	 	location.href=WST.AU('pintuan://carts/settlement');
	    	 });
	     }else{
