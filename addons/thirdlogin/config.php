...
return array(
	'kd_tips1'=>array(
		'title'=>'<div style="color:blue;">说明：微信公众号中绑定登录与PC第三方微信登录不同【微信公众号登录使用的是公众平台，PC使用的是开放平台】;<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;相关的配置请参照第三方登录配置文档进行配置;</div>',
		'type'=>'hidden',
		'value'=>''
	),
	'thirdTypes'=>array(
			...
			'qq'=>array(
				...
				'options'=>array(
					'qq_tips'=>array(
						...
						<div style="color:red;">如果有多端使用QQ登录，则需要使用unionId机制,需要给腾讯客服发邮件开通，具体操作请查看《wstmart v2.0用户手册》</div>',
						'type'=>'hidden',
						'value'=>'',
						'tip'=>''
					),
