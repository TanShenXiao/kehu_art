	...
	public function install(){
		...
		try{
			$hooks = array("afterUserRegist","beforeUserLogin","afterUserLogin","afterUserLogout","homeControllerBase",
							"afterEditPass","afterEditEmail","homeControllerUsersEditEmail","shopControllerUsersEditEmail","adminAfterAddUser","adminAfterEditUser",
