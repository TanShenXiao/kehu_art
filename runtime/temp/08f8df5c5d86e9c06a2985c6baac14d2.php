<?php /*a:2:{s:89:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\suppliersettlements\list_supplier.html";i:1585536506;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<style type="text/css">
    #mmg td:nth-child(7){color: red}
</style>
<div id='alertTips' class='alert alert-success alert-tips fade in'>
  <div id='headTip' class='head'><i class='fa fa-lightbulb-o'></i>操作说明</div>
  <ul class='body'>
    <li>本功能主要用于查看供货商未结算订单。</li>
  </ul>
</div>
...
<button class="btn btn-primary" type='button' onclick='javascript:loadSupplierGrid()'><i class='fa fa-search'></i>查询</button>
...
<script src="__ADMIN__/suppliersettlements/settlements.js?v=<?php echo $v; ?>" type="text/javascript"></script>
