<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\logstafflogins\list.html";i:1602924237;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<input type="text" id="endDate" name="endDate" class="laydate-icon ipt" placeholder='结束日期' maxLength="20"  />
  <input type="text" id="staffName" name="staffName" class="ipt" placeholder='职员名称' maxLength="20" />
  <input type="text" id="loginIp" name="loginIp" class="ipt" placeholder='登陆IP' maxLength="20" />
...
<script src="__ADMIN__/logstafflogins/logstafflogins.js?v=<?php echo $v; ?>" type="text/javascript"></script>
