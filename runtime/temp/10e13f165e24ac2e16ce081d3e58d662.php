<?php /*a:2:{s:104:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\shopmembergroups\list.html";i:1608739097;s:87:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\base.html";i:1602924165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class='wst-toolbar'>
   <input type='text' id="groupName2" name='groupName2' class="s-query" placeholder='分组名称'/>
   <a class="btn btn-primary" onclick="loadGrid(0)"><i class="fa fa-search"></i>查询</a>
   <a class="btn btn-success" style="float:right;" href="javaScript:toEdit(0)"><i class="fa fa-plus"></i>添加</a>
</div>
<div class='wst-grid'>
...
<div id='editBox' style='display:none'>
    ...
    <table class='wst-form wst-box-top'>
       <tr>
          <th width='80'>分组名称<font color='red'>*</font>：</th>
          <td><input type='text' id='groupName' name="groupName"  class='ipt' maxLength='20' style='width:200px'/></td>
       </tr>
       <tr>
          <th >排序号：</th>
          <td><input type='text' id='groupOrder' name="groupOrder"  class='ipt' maxLength='5' style='width:150px'/></td>
       </tr>
        <tr>
            <th >最低消费(大于或等于)<font color='red'>*</font>：</th>
            <td><input type='text' id='minMoney' name="minMoney"  class='ipt' maxLength='10' onblur="javascript:WST.limitDecimal(this,2)" onkeypress="return WST.isNumberdoteKey(event)" onkeyup="javascript:WST.isChinese(this,1)" style='width:150px'/></td>
        </tr>
        <tr>
            <th >最高消费(小于)<font color='red'>*</font>：</th>
            <td><input type='text' id='maxMoney' name="maxMoney"  class='ipt' maxLength='10' onblur="javascript:WST.limitDecimal(this,2)" onkeypress="return WST.isNumberdoteKey(event)" onkeyup="javascript:WST.isChinese(this,1)" style='width:150px'/></td>
        </tr>
    </table>
    </form>
 </div>
...
<script type='text/javascript' src='__SHOP__/shopmembergroups/list.js?v=<?php echo $v; ?>'></script>
<script>
    $(function(){
        initGrid(<?php echo $p; ?>);
    });
