<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\supplierorders\list.html";i:1608279909;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<input type="hidden" id="supplierId" class="j-ipt" value='<?php echo $supplierId; ?>' autocomplete="off"/>
<div class="wst-toolbar">
<div id='moreItem' class='hide'>
<?php if($src!='suppliers'): ?>
  <select id="areaId1" class='ipt j-ipt' level="0" onchange="WST.ITAreas({id:'areaId1',val:this.value,className:'j-ipt'});">
  <option value="-1">-供货商所在地-</option>
...
<?php if($src!='suppliers'): ?>
<input type="text" name="shopName"  placeholder='供货商名称/供货商编号' id="shopName" class='j-ipt'/>
<?php endif; ?>
...
<select id='payFrom' class='j-ipt'>
 ...
 <?php endforeach; endif; else: echo "" ;endif; ?>
   ...
   <?php if(($userId>0)): ?><button class="btn f-right btn-fixtop" onclick="javascript:location.href='<?php echo Url('admin/users/index','p='.$p); ?>'" style="margin-left: 10px;"><i class="fa fa-angle-double-left"></i>返回</button><?php endif; if(WSTGrant('GDDLB_05')): ?>
...
<script src="__ADMIN__/supplierorders/orders.js?v=<?php echo $v; ?>" type="text/javascript"></script>
