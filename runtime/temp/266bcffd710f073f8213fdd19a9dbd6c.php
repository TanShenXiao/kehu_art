<?php /*a:2:{s:74:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\userscores\ranking.html";i:1602924252;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar">
  <input type="text" id="month" name="month" placeholder='月份' class="laydate-icon ipt" maxLength="10" value='<?php echo date('Y-m'); ?>' />
  <button class="btn btn-primary btn-mright" onclick='javascript:loadGrid()'><i class='fa fa-search'></i>查询</button>
...
<script src="__ADMIN__/userscores/ranking.js?v=<?php echo $v; ?>" type="text/javascript"></script>
