<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\reports\stat_user_login.html";i:1602924243;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<input type="text" placeholder='开始日期' id="startDate" name="startDate" class="laydate-icon ipt" maxLength="20" value='<?php echo $startDate; ?>'/>
至
<input type="text" placeholder='结束日期' id="endDate" name="endDate" class="laydate-icon ipt" maxLength="20" value='<?php echo $endDate; ?>'/>
...
<script src="__ADMIN__/reports/stat_user_login.js?v=<?php echo $v; ?>" type="text/javascript"></script>
