<?php /*a:2:{s:96:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\messages\list.html";i:1602924176;s:87:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\base.html";i:1602924165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class='wst-toolbar'>
    <button class="btn btn-danger f-right" onclick="batchDel()"><i class="fa fa-trash-o"></i>批量删除</button>
    <button class="btn btn-success f-right" style='margin-right:5px;' onclick="batchRead()"><i class="fa fa-pencil"></i>标记为已读</button>
...
<script type='text/javascript' src='__SHOP__/messages/message.js?v=<?php echo $v; ?>'></script>
<script>
    $(function(){
        initGrid(<?php echo $p; ?>);
    });
