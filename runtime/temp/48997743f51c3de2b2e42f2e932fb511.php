<?php /*a:2:{s:76:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\logshopoperates\list.html";i:1586933926;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id='alertTips' class='alert alert-success alert-tips fade in'>
  ...
  <ul class='body'>
    <li>该功能主要用于查看商家的操作日志信息。点击“查看”可以查看该操作传送到后台的传送内容。</li>
  </ul>
</div>
...
<input type="text" id="endDate" name="endDate" class="laydate-icon ipt" placeholder='结束日期' maxLength="20"  />
  ...
  <input type="text" id="shopName" name="shopName" class="ipt" placeholder='所属商家' maxLength="200" />
...
<script src="__ADMIN__/logshopoperates/logshopoperates.js?v=<?php echo $v; ?>" type="text/javascript"></script>
