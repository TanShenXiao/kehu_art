<?php /*a:2:{s:81:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\admin\view\index.html";i:1603010576;s:80:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wrapper">
  <header class="main-header">
    <a href="<?php echo Url('admin/index/main'); ?>" target="iframe" class="logo">
      ...
      <span class="logo-lg" style="font-size:20px">重庆艺术大市场</span>
    </a>
...
<div id='editPassBox' style='display:none;padding-top:5px;'>
  <form id='editPassFrom' autocomplete="off">
   <table class='wst-form'>
      ...
      <tr>
         <th>新密码：</th>
         <td><input type='password' id='newPass' style='width:210px' name='newPass' class='ipt' data-rule="新密码: required;length[6~];password" maxLength='16'/></td>
      </tr>
      <tr>
         <th>确认密码：</th>
