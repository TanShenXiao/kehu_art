<?php /*a:1:{s:81:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\admin\view\login.html";i:1602924233;}*/ ?>
<!DOCTYpE html>
<html>
<head>
  ...
  <div class="wst-lo">
    <div class="login-header">
        ...
        <div class="login_title">
          <div class='title_cn'>重庆艺术大市场后台管理系统</div>
        </div>
    ...
    <div class="login-footer">
      <div class="line1"></div>
      <div class="line2"></div>艺术创造价值，文化成就人生</div>
  </div>
</div>
...
<script>
window.conf = {"DOMAIN":"<?php echo str_replace('index.php','',app('request')->root(true)); ?>","ROOT":"","APP":"/index.php","STATIC":"/static","SUFFIX":"<?php echo config('url_html_suffix'); ?>","IS_CRYPT":"<?php echo WSTConf('CONF.isCryptPwd'); ?>"}
</script>
