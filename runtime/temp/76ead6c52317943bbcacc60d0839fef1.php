<?php /*a:2:{s:100:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\goodsconsult\list.html";i:1602924169;s:87:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\base.html";i:1602924165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar">
    ...
    <input type="text" id="consultKey" class="s-query" placeholder='咨询关键词'/>
    <a class="s-btn btn btn-primary" onclick="loadGrid()"><i class="fa fa-search"></i>查询</a>
    <a class="btn btn-primary f-right"  onclick="editConsult(0,-1)"><i class="fa fa-pencil"></i>批量隐藏</a>
    <a class="btn btn-primary f-right" onclick="editConsult(1,-1)" style='margin-right:5px;'><i class="fa fa-pencil"></i>批量显示</a>
</div>
<div class='wst-grid'>
...
<script type='text/javascript' src='__SHOP__/goodsconsult/goodsconsult.js?v=<?php echo $v; ?>'></script>
<script>
$(function(){
