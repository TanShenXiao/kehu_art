<?php /*a:2:{s:95:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\express\list.html";i:1602924167;s:87:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\base.html";i:1602924165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar">
  <input type="text" name="expressName" id="expressName" class="s-query" placeholder='快递名称'/>
  <a class="s-btn btn btn-primary" onclick="loadGrid1(0)"><i class="fa fa-search"></i>查询</a>
</div>
<div class='wst-grid'>
...
<script type='text/javascript' src='__SHOP__/express/express.js?v=<?php echo $v; ?>'></script>
<script>
    $(function(){
        initGrid1(<?php echo $p; ?>);
    });
</script>
