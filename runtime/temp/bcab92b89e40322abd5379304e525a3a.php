...
<link rel="stylesheet"  href="__MOBILE__/css/art_collect.css?v=<?php echo $v; ?>"/>
...
<section class="ui-container">
		...
		<div class="sector_pack">
			<?php echo $goodscats['articleContent']; ?>
		</div>
<div class="contact">
