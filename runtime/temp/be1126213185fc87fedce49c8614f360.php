<?php /*a:2:{s:97:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\shoproles\list.html";i:1602924183;s:87:"D:\soft\phpstudy\phpstudy_pro\WWW\three\www.art.com\wstmart\shop\view\default\base.html";i:1602924165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class='wst-toolbar'>
   <input type='text' id="roleName" name='roleName' class="s-query" placeholder='角色名称'/>
   <a class="btn btn-primary" onclick="loadGrid()"><i class="fa fa-search"></i>查询</a>
...
<script type='text/javascript' src='__SHOP__/shoproles/shoproles.js?v=<?php echo $v; ?>'></script>
<script>
    $(function(){
        initGrid(<?php echo $p; ?>);
    });
