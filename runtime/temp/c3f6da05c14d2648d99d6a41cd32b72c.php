<?php /*a:2:{s:74:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\articles\edit_help.html";i:1602924207;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
   ...
   <tr>
    ...
    <tr>
       <td colspan='2' align='center'>
        ...
        <button type="button" class="btn" onclick="javascript:location.href='<?php echo Url('admin/articles/help','p='.$p); ?>'"><i class="fa fa-angle-double-left"></i>返&nbsp;回</button>
       </td>
    </tr>
</table>
 </form>
...
<script src="__ADMIN__/articles/help.js?v=<?php echo $v; ?>" type="text/javascript"></script>
<script>
$(function () {
