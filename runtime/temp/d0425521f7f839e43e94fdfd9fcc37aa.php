...
<link rel="stylesheet"  href="__MOBILE__/css/art_service.css?v=<?php echo $v; ?>"/>
...
<section class="ui-container">
		<ul class="zp_big_category" style="background: #eeeeee;margin-bottom: 2px;">
			...
			<li style="width: 20%;"><a href="<?php echo url('mobile/shops/artCollect'); ?>">作品征集</a><div style="height: 2px;background:rgb(211,3,35);position: relative;top: -10px;width: 60%;margin: 0 auto;"></div></li>
		...
		<div class="sector_pack">
			<?php 
				foreach($goodscats as $ak => $av){
			 ?>
				<li>
					<a href="<?php echo url('mobile/shops/artCollect',['articleId'=>$av['articleId']]); ?>">
						<img src="/<?php echo $av['coverImg']; ?>" alt="">
						<div class="sector_desc">
							<h2><?php echo $av['articleTitle']; ?></h2>
							<p><?php echo $av['articleDesc']; ?></p>
						</div>
					</a>
				</li>
			<?php } ?>
