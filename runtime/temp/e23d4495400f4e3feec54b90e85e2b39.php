<?php /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\reports\cash_drawal_money.html";i:1602924241;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<select id='targetType' class='ipt'>
    <option value='-1'>会员类型</option>
    <option value='0'>会员</option>
    <option value='1'>商家</option>
</select>
<input type="text" name="cashNo"  placeholder='提现单号' id="cashNo" class='ipt'/>
...
<span class="f-right">提现总金额:<span style="color:red;font-weight:bold;" id="totalMoney">0</span>元&nbsp;&nbsp;&nbsp;</span>
</div>
<div class="wst-tips-box">
    <div class="icon"></div>
    <div class="tips">该统计只统计提现成功的记录</div>
...
<script src="__ADMIN__/reports/cash_drawal_money.js?v=<?php echo $v; ?>" type="text/javascript"></script>
