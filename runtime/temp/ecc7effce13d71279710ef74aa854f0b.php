<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\suppliers\list.html";i:1587710038;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar">
	...
	<input type="text" id="supplierName"  placeholder='供货商名称' id="supplierName" class='j-ipt'/>
	<select id="tradeId" class='j-ipt'>
        <option value="">-所属行业-</option>
        <?php $_result=WSTTrades(0);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <option value="<?php echo $vo['tradeId']; ?>"><?php echo $vo['tradeName']; ?></option>
        <?php endforeach; endif; else: echo "" ;endif; ?>
  	</select>
