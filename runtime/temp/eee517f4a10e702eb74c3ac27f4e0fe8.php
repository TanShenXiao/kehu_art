<?php /*a:2:{s:78:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\supplierarticles\guide.html";i:1587916469;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  <div class="layui-tab-content" >
    <div class="layui-tab-item layui-show">
		<div class="wst-toolbar">
		   ...
		   <?php endif; if(WSTGrant('GRZZN_01')): ?>
    ...
    <div class="layui-tab-item">
		...
		<table class='wst-form wst-box-top '>
		   <tr>
		       <td align='center'>入驻协议</th>
		   </tr>
		       <td align='center'>
		       	<?php if(WSTGrant('GRZZN_02')): ?> 
...
<script src="__ADMIN__/supplierarticles/guide.js?v=<?php echo $v; ?>" type="text/javascript"></script>
<script>
