<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\templatemsgs\edit_email.html";i:1602924250;s:60:"D:\phpstudy_pro\WWW\www.art.com\wstmart\admin\view\base.html";i:1602924209;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<table class='wst-form wst-box-top layui-form'>
  <tr>
     ...
     <td>
         <?php $_result=WSTDatas("TEMPLATE_EMAIL");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['dataVal']==$object['tplCode']): ?><?php echo $vo['dataName']; ?><?php endif; ?>
  ...
  <tr>
   ...
   <tr>
	     <th>是否开启：</th>
	     <td>
	     <input type="checkbox" <?php if($object['status']==1): ?>checked<?php endif; ?> value='1' class="ipt" id="isShow2" name="seoMallSwitch" lay-skin="switch" lay-filter="isShow2" lay-text="开启|关闭">
	     </td>
	  </tr>
  <tr>
  ...
  <tr>
     <td colspan='2' align='center' class='wst-bottombar' style="padding-left: 125px;">
     	<button type="button" class="btn btn-primary btn-mright" onclick='javascript:save(1,<?php echo $p; ?>)'><i class="fa fa-check"></i>保存</button>
