...
<body>
    ...
    <div class="copyright">
        <span style='color:#777;'><a style='text-decoration:none;color:#777;' title="官方网站" href="http://artmart.cqcaee.com">cqcaee</a> @ <a style='text-decoration:none;color:#777;' title="官方网站" href="http://artmart.cqcaee.com">重庆艺术大市场</a></span> 
    </div>
    <?php if(\think\facade\App::isDebug()) { ?>
    <script>
