...
class Banks extends Base{
	...
	public function edit(){
		...
		$validate = new validate();
		if(!$validate->scene('edit')->check(['bankName'=>input('post.bankName'),'bankImg'=>input('post.bankImg')]))return WSTReturn($validate->getError());
	    $result = $this->allowField(['bankName','bankImg'])->save(['bankName'=>input('post.bankName'),'bankImg'=>input('post.bankImg')],['bankId'=>$bankId]);
