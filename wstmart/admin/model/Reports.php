...
class Reports extends Base{
    ...
    public function shopExpireByPage(){
        ...
        $page =  Db::table('__SHOPS__')->alias('s')
            ...
            ->where($where)
            ->field('u.loginName,shopSn,shopName,t.tradeName,shopAddress,expireDate')
            ->paginate(input('limit/d'))->toArray();
        return $page;
    }
    ...
    public function toExportShopExpire(){
        ...
        $objPHPExcel->getActiveSheet()
            ...
            ->setCellValue('B1', '店铺账号')
            ->setCellValue('C1', '店铺名称')
            ->setCellValue('D1', '所属行业')
            ->setCellValue('E1', '店铺地址')
            ->setCellValue('F1', '到期日期');
