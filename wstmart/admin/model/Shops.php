...
class Shops extends Base{
	...
	public function pageQuery($shopStatus=1){
		...
		$page =  Db::table('__SHOPS__')->alias('s')
			       ...
			       ->where($where)
			       ->field('u.loginName,s.shopId,s.shopSort,shopSn,shopName,t.tradeName,a2.areaName,shopkeeper,telephone,shopAddress,shopCompany,shopAtive,shopStatus,expireDate')
			       ->order($order)
