...
class Users extends Base{
	...
	public function pageQuery(){
	    ...
	    foreach ($rs['data'] as $key => $v) {
	    	...
	    	$rs['data'][$key]['userName'] = WSTAnonymous($rs['data'][$key]['userName']);
			$rs['data'][$key]['userPhone'] = WSTAnonymous($rs['data'][$key]['userPhone']);
			$rs['data'][$key]['userEmail'] = WSTAnonymous($rs['data'][$key]['userEmail']);
	    }
		return $rs;
	}
