...
function initGrid(p){
    ...
    var cols = [
			...
			{title:'供货商名称', name:'supplierName',width: 100,sortable: true,renderer: function (val,item,rowIndex){
            ...
            {title:'操作', name:'' ,width:180, align:'center', renderer: function(val,item,rowIndex){
	            ...
	            h += "<a class='btn btn-blue' href='"+WST.U('admin/supplierorders/index','supplierId='+item['supplierId']+'&src=suppliers&p='+WST_CURR_PAGE)+"&type=3'><i class='fa fa-search'></i>订单信息</a>";
	            return h;
            }}
            ];
...
function initStopGrid(p){
    ...
    var cols = [
			...
			{title:'供货商名称', name:'supplierName',width: 120,sortable: true,renderer: function (val,item,rowIndex){
