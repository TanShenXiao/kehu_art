...
class Goods extends Validate{
    ...
    protected function checkGoodsSn($value){
    	...
    	$isChk = model('Goods')->checkExistGoodsKey('goodsSn',$key,$goodsId,Input('post.shopId/d',0));
    ...
    protected function checkProductNo($value){
    	...
    	$isChk = model('Goods')->checkExistGoodsKey('productNo',$key,$goodsId,Input('post.shopId/d',0));
