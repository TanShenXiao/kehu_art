...
class Shops extends Validate{
	...
	protected $message  =  [
        ...
        'shopAddress.require' => '请输入详细地址',
        'shopTel.require' => '请输入公司电话',
        'shopkeeper.require' => '请输入紧急联系人',
        'telephone.require' => '请输入紧急联系人电话',
        ...
        'legalCertificateImg.require' => '请上传法人证件电子版或个人身份证扫描件',
    ...
    public $scene = [
		...
		'applyStep2_personal'=>['areaIdPath0','shopAddress','shopTel','shopkeeper','telephone','legalCertificateImg','shopEmergencyLinkMan'],
        'applyStep3_personal'=>['bankUserName','bankNo','bankId','bankAreaId']
    ]; 
