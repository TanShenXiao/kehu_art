$(function() {
	...
	$(".ck-slide-wrapper img").width(width);
	$('.ck-slide').ckSlide({
		autoPlay: true,
		time:5000,
		isAnimate:true,
	...
	$('#keeper-showmore').click(function(){
		$('#keeper-info').css({'height': '100%'});
		$('#keeper-info').css({'-webkit-line-clamp': '999'});
		$('#keeper-showmore').hide(),$('#keeper-exmore').show();
	});
	$('#keeper-exmore').click(function(){
		$('#keeper-info').css({'height': '64px'});
		$('#keeper-info').css({'-webkit-line-clamp': '3'});
		$('#keeper-exmore').hide(),$('#keeper-showmore').show();
	});
});
