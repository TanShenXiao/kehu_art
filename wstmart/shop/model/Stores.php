...
use wstmart\shop\validate\Stores as VStores;
use think\Db;
/**
 * ============================================================================
 * WSTMart多用户商城
    ...
    */
    ...
    public function edit(){
        ...
        try{
            ...
            if($loginPwd!=""){
                ...
                $decrypt_data2 = WSTRSA($reUserPwd);
                if($decrypt_data['status']==1 && $decrypt_data2['status']==1){
                    $loginPwd = $decrypt_data['data'];
                }else{
                    return WSTReturn("修改失败", -1);
                }
                if($decrypt_data['data']!=$decrypt_data2['data']){
                    return WSTReturn("两次输入密码不一致!");
                }
    ...
    public function pageQuerySalestatistics(){
        ...
        if($startDate!="" && $endDate!=""){
            $condition[] = ['o.createTime','between',[$startDate,$endDate]];
        }
