...
class SupplierOrders extends Base{
	...
	public function getByView($orderId, $uId=0){
		...
		$orders = Db::name('supplier_orders')->alias('o')
		               ...
		               ->field('o.*,s.areaId supplierAreaId,s.supplierAddress,s.supplierTel,s.supplierName,s.supplierQQ,s.supplierWangWang,s.latitude,s.longitude,orf.id refundId,orf.refundRemark,orf.refundStatus,orf.refundTime,orf.backMoney,orf.backMoney,oc.complainId')->find();
