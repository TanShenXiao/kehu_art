...
class Goods extends Base{
	...
	public function index(){
        ...
        // 删除无用字段
        WSTUnset($goods,'goodsSn,productNo,isSale,goodsCatIdPath,goodsCatId,shopCatId1,shopCatId2,brandId,goodsStatus,saleTime,goodsSeoKeywords,illegalRemarks,dataFlag,createTime,read');
        // 猜你喜欢6件商品
    ...
    public function pageQuery(){
        ...
        $rs['showWay'] = model("GoodsCats")->where(['catId'=>$catId,'dataFlag'=>1])->value('showWay');
