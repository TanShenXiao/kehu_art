...
Page({
  ...
  showAssify: function (e) {
    var that = this;
     var viceArray = this.data.viceArray?this.data.viceArray:[];
     ...
     if (e.length) {
       var catId = 0;
       viceArray = mainArray[0]['childList']?mainArray[0]['childList']:[];
     ...
     for (let i = 0; i < mainArray.length; i++) {
       if(mainArray[i].catId == catId){
         viceArray = mainArray[i]['childList']?mainArray[i]['childList']:[];
