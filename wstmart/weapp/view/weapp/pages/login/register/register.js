...
Page({
  ...
  register: function (){
    ...
    var avatarUrl = app.globalData.userInfo.avatarUrl ? app.globalData.userInfo.avatarUrl:'';
    var nickName = app.globalData.userInfo.nickName ? app.globalData.userInfo.nickName:'';
    var gender = app.globalData.userInfo.gender ? app.globalData.userInfo.gender:0;
