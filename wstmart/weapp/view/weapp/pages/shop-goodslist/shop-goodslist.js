  ...
  getShopInfo: function () {
    ...
    http.Post('weapp/shops/selfshop', { num: num, shopId: shopId }, function (res) {
      ...
      if (res.status == 1 && res.data) {
        ...
        if(res.data.hot)hot = res.data.hot;
        if(res.data.rec)recommond = res.data.rec;
        shopArray = res.data.shop;
        sortInfo = res.data.shopcats;

        that.setData({
          hots:res.data.shop.shopHotWords,
          hot: hot,
          recommond: recommond,
          shopArray: shopArray,
          sortInfo: sortInfo
  ...
  powerDrawer(e) {
    if (e.currentTarget.dataset.page != 2) {
      ...
      if (e.currentTarget.dataset.minid) {
        ct2 = e.currentTarget.dataset.minid;
        ct1 = e.currentTarget.dataset.maxid;
      } else {
        ct2 = this.data.ct2;
        ct1 = this.data.ct1;
      }
      ...
      this.setData({
          searchContent: e.currentTarget.dataset.key
      });
      this.search2();
    }
  },
