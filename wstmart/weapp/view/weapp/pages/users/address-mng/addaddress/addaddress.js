  ...
  getAddressInfo: function (data, url) {
    ...
    http.Post('weapp/UserAddress/' + url, data, function (res) {
      if (res.status == 1) {
        ...
        if (res.data.userPhone) userPhone = res.data.userPhone;
        if (res.data.areaName) areaName = res.data.areaName;
        if (res.data.userAddress) userAddress = res.data.userAddress;
        if (res.data.areaId) areaId = res.data.areaId;
        that.setData({
          userName: userName,
          userPhone: userPhone,
          areaName: areaName,
